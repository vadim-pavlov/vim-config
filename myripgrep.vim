...
function! s:reset() abort
    ...
    call myripgrep#stop()
    call setqflist([], 'r')
    call ripgrep#observe#add_observer(g:ripgrep#event#match, 'myripgrep#__register_match')
endfunction

function! myripgrep#__register_match(item) abort
...
function! myripgrep#search(arg) abort
    ...
    call myripgrep#call(l:cmd, l:cwd[0], l:cwd[1])
endfunction

function! myripgrep#call(cmd, cwd, rel) abort
    call s:reset()
