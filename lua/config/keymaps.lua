...
map('n', '<leader>sa', ':wa<CR>', { silent = true, desc = "Save all buffers" })
map('n', '<leader>ss', ':w<CR>', { silent = true, desc = "Save the current buffer" })
map('n', '<leader>sq', ':wq<CR>', { silent = true, desc = "Save and close current buffer" })
map('n', '<leader>qq', ':q<CR>', { silent = true, desc = "Quit the current window" })
map('n', '<leader>qa', ':qa<CR>', { silent = true, desc = "Quit all windows" })
map('n', '<leader>qo', [[:%bd | e#<CR>]], { silent = true, desc = "Delete all but current buffer" })
